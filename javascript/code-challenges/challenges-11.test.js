...
let findShortest = (data) => {
  return data.reduce((shortestChar, currChar) => {
    return Number(shortestChar.height) < Number(currChar.height) ? shortestChar : currChar;
  }).name;
};
